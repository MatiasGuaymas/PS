...
def sitios(CATEGORIES):
    ACTIVE_STATE = 1  # Asumiendo que el ID del estado 'Activo' es 1
    sites = []
    ...
    sites.append(Site(
        ...
        operning_year=1608,
        category_id=CATEGORIES['ARQ'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
    ...
    sites.append(Site(
        ...
        operning_year=1891,
        category_id=CATEGORIES['CULT'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
        ...
        operning_year=2001,
        category_id=CATEGORIES['MONU'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
    ...
    sites.append(Site(
        ...
        operning_year=1882,
        category_id=CATEGORIES['RELI'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
        ...
        operning_year=1100,
        category_id=CATEGORIES['FORT'], state_id=ACTIVE_STATE
    ))
    ...
    sites.append(Site(
        ...
        city='Río Grande', province='Tierra del Fuego',
        location=WKTElement('POINT(-67.750000 -53.799700)', srid=4326),
        operning_year=1893,
        category_id=CATEGORIES['RELI'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
        site_name='Estancia San Gregorio',
        short_desc='Ruinas de estancia patagónica',
        ...
        location=WKTElement('POINT(-69.052000 -52.261000)', srid=4326),
        operning_year=1880,
        category_id=CATEGORIES['ARQ'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
    ...
    sites.append(Site(
        site_name='Castillo de la Amistad',
        short_desc='Edificio histórico de La Plata',
        ...
        location=WKTElement('POINT(-57.990400 -34.908000)', srid=4326),
        operning_year=1920,
        category_id=CATEGORIES['ARQ'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
    ...
    sites.append(Site(
        ...
        city='San Nicolás', province='Buenos Aires',
    ...
    sites.append(Site(
        ...
        operning_year=7378, # 7378 A.C. se traduce a un año numérico
        category_id=CATEGORIES['NAT'], state_id=ACTIVE_STATE
    ))
    sites.append(Site(
