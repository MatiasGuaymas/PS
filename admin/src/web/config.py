...
class ProductionConfig(config):
    ...
    MINIO_SERVER = os.getenv("MINIO_MINIO_SERVER", "minio.proyecto2025.linti.unlp.edu.ar")
    MINIO_ACCESS_KEY = os.getenv("MINIO_MINIO_ACCESS_KEY", "QdcezP7tN0XuAt6Vlv4M")
    MINIO_SECRET_KEY = os.getenv("MINIO_MINIO_SECRET_KEY", "Rmjc12vculzWGkxbr7VI9gos0fV6QOjHMKIenk2M")
    MINIO_SECURE = True
